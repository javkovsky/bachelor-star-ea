...
def omnifold(theta0_G, theta0_S, theta_unknown_S,
             iterations, model, verbose=0):
    ...
    for i in range(iterations):
        ...
        model_history_step1 = model.fit(X_train_1,
                  Y_train_1,
                  epochs=20,
                  batch_size=10000,
        ...
        # STEP 2: classify Gen. to reweighted Gen.
        # (which is reweighted by weights_pull)
        # weights Gen. --> reweighted Gen.
        # P(gen_reweighted:x_gen)/P(gen_original:x_gen)
    ...
    return weights, model_history_step1